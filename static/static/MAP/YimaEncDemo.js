...
function API_GetMercatorPoByLonLatPo(lonLat)
{
    var  mercator = [];
...
function init() {
    ...
    //API_SetMapMinMaxScale(5000, 10240000);
    ...
    //API_SetMapViewCenter(121.5, 31.5, 5120000); //设置海图显示信息，假如不设置，那么海图可能不显示出来

    //API_SetMapImagesUrl("http://localhost:3000/");
    ...
    //API_SetMapBackGroundStyle("../sdk/img/moveBarPan.png", "#FFFF00");
    API_SetMapBackGroundStyle(null, "#FFFFFF");
    /*
